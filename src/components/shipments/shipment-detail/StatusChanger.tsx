...
const icons = {
  'OPEN': <ShopOutlined style={{color: '#1890ff'}} />,
  'IN_TRANSIT': <TruckOutlined style={{color: 'orange'}} />,
  ...
  return (
    <Card size="small">
      ...
      <div className="flex items-center gap-3 mb-2">
        {icons[shipment.status]} <StatusBadge status={shipment.status} />
      </div>
        ...
        <div className="space-y-2">
          ...
          {availableActions.length ? (
            ...
            <div className="flex flex-col items-center justify-center py-4 text-gray-500">
              ...
              <Text>Shipment is completed</Text>
